...
class RoomResourceIT {
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room().roomNumber(DEFAULT_ROOM_NUMBER).price(DEFAULT_PRICE);
        return room;
    }
    ...
    public static Room createUpdatedEntity(EntityManager em) {
        Room room = new Room().roomNumber(UPDATED_ROOM_NUMBER).price(UPDATED_PRICE);
        return room;
    }
    ...
    void putNewRoom() throws Exception {
        ...
        updatedRoom.roomNumber(UPDATED_ROOM_NUMBER).price(UPDATED_PRICE);
    ...
    void fullUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.roomNumber(UPDATED_ROOM_NUMBER).price(UPDATED_PRICE);
